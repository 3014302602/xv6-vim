...
00000462 <showC>:
SYSCALL(showC)
 462:	b8 21 00 00 00       	mov    $0x21,%eax
 467:	cd 40                	int    $0x40
 469:	c3                   	ret    
